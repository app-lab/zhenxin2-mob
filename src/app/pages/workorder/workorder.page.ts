...
export class WorkorderPage implements OnInit, OnDestroy {
	...
	constructor(
		...
		public mywebsocket: MywebsocketService,
	...
	getList() {
		this.apiServer
			.getToken('production/private/workorder', {
				page: this.page,
				limit: this.limit,
				status: this.status,
				searchVal: this.searchVal,
				stationId: this.selectedProvince,
				procedureId: this.selectedCity,
			})
			.subscribe(res => {
