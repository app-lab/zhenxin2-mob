...
export class InoutService {
    ...
    post(url: string, body: any): Observable<any> {
        return this.http.post<any>(this.excuteUrl + url, body, this.createOptions())
    }

    getToken(url: string, body: any): Observable<any> {
        return this.http.get<any>(this.excuteUrl + url + this.buildparams(body), this.createOptions())
    }
